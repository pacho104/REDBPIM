...
@section('content')
    ...
    <h3 class="text-center">
        Listas de Chequeo del Municipio
    </h3>
    <div class="row-fluid">
        <div class="container" id="admin">
            ...
            <ul id="alignrightCreate" class="nav nav-tabs navbarfont navbar-right">
                <li><a href="{{url('creaLiMun')}}">
                        <i class="fa fa-plus"></i> &nbsp Crear Nueva Lista de Chequeo </a></li>
            </ul>
            {!!Form::model(Request::all(),['route'=>'lisM','method'=>'GET','class'=>'navbar-form navbar-left pull-right','role'=>'search']) !!}
            ...
            <table class="table table-striped  table-bordered">
                ...
                <th class="col-md-2" align="center">Nombre de la Lista</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group-justified">
                                <a  href="editLiMun/{{$lis->id}}" class="btn btn-warning col-md-2">EDITAR
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a  href="{{route('reqMun',"$lis->id")}}" class="btn btn-primary col-md-3">REQUISITOS
                                    <i class="fa fa-list-alt"></i>
                                </a>
                                <a data-toggle="modal" data-target="#ConfirmDelete-{{$lis->id}}" href="#ConfirmDelete-{{$lis->id}}"
                                   class="btn btn-danger col-md-2">ELIMINAR
                                    <i class="fa fa-trash">
                                    </i>
                                </a>
