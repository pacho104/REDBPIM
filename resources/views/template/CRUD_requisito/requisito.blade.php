...
@section('content')
    ...
    <h3 class="text-center">
        Requisitos Para Listas de Chequeo De Toda La Red
    </h3>
    ...
    <div class="row-fluid">
        <div class="container" id="admin">
            ...
            <ul id="alignrightCreate" class="nav nav-tabs navbarfont navbar-right">
                <li><a href="{{route('requisito.create')}}">
                        <i class="fa fa-plus"></i> &nbsp Crear Nuevo Requisito </a></li>
            </ul>
            {!!Form::model(Request::all(),['route'=>'requisito.index','method'=>'GET','class'=>'navbar-form navbar-left pull-right','role'=>'search']) !!}
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group-justified">
                                <a  href="{{route('requisito.edit',"$re->id")}}" class="btn btn-warning">EDITAR
