            ...
            <div class="col-md-8">
                ...
                <fieldset>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {!!Form::text('nombre_proceso',$procesoBan->nom_proceso,['class'=>'form-control','placeholder'=>'Ingrese
                            el nombre'])!!}
                        </div>
                    </div>
                    <br><br>
                    {!!Form::button('Actualizar',['class'=>'btn btn-block
