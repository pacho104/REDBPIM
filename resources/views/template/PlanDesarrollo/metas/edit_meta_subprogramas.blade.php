...
@section('content')
    ...
    <div class="row-fluid">
        ...
        <div class="container">
            ...
            <div class="col-md-8">
                {!! Form::open(['url' => 'admin/plan_desarrollo/meta/subPrograma/'.$meta->id.'/refresh', 'autocomplete' => 'off']) !!}
                <fieldset>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group" id="valuesubProgramaedit">
                                <label class="col-md-3 control-label">Nombre:</label>
                                <div class="col-md-8">
                                    {!! Form::select('subPrograma',
                                    ($list_subPrograma),
                                    $meta_subPrograma->id_sub_programa,
                                    ['class' => 'form-control'])
                                    !!}
                                </div>
                            </div>
