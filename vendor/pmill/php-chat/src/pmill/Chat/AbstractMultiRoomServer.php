...
abstract class AbstractMultiRoomServer implements MessageComponentInterface
{
     ...
     * @return IoServer
     */
    public static function run(AbstractMultiRoomServer $chatServer, $port, $ip='127.0.0.1')
    {
    ...
    public function onMessage(ConnectionInterface $conn, $msg)
    {
        ...
        switch ($msg['action']) {
            case self::ACTION_USER_CONNECTED:
                ...
                $this->usersNuevosLista($client,$roomId);
    ...
    protected function closeClientConnection(ConnectionInterface $conn)
    {
        ...
        if (isset($clientRoomId)) {
            ...
            $this->usersNuevosLista($client,$clientRoomId);
        }
    }
    ...
    protected function usersNuevosLista(ConnectedClientInterface $client, $roomId){
